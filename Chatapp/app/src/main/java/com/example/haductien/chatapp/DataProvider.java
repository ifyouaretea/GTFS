...
public class DataProvider extends ContentProvider {
    ...
    public static final Uri CONTENT_URI_MESSAGES = Uri.parse("content://com.example.haductien.chatappt.provider/messages");
    public static final Uri CONTENT_URI_PROFILE = Uri.parse("content://com.example.haductien.chatapp.provider/profile");
    ...
    static {
        ...
        uriMatcher.addURI("com.example.haductien.chatapp.provider", "messages", MESSAGES_ALLROWS);
        uriMatcher.addURI("com.example.haductien.chatapp.provider", "messages/#", MESSAGES_SINGLE_ROW);
        uriMatcher.addURI("com.example.haductien.chatapp.provider", "profile", PROFILE_ALLROWS);
        uriMatcher.addURI("com.example.haductien.chatapp.provider", "profile/#", PROFILE_SINGLE_ROW);
    }
}
